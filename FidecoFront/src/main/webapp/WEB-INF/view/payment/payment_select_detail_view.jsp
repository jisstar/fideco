...
<body>
    ...
    <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <a href="./PaymentUpdate.py?payment_id=${paymentDTO.payment_id}" class="btn btn-warning btn-block">결제 정보 수정</a>
            </div>
            <div class="col-md-4">
                <a href="./PaymentDeleteView.py?payment_id=${paymentDTO.payment_id}" class="btn btn-danger btn-block">결제 정보 삭제</a>
            </div>
        </div>
    </div>
</body>
