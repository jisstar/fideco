...
<div class="card-body">
 ...
 <th> 결제 아이디 </th> <th> 결제 금액 </th> <th> 결제 일자 </th> <th>결제 방법</th>
 </tr>
 </thead>
 <tbody>
 ...
 <td>${arrayList.payment_date}</td>
  ...
  <button type="button" onclick="location.href='./PaymentSelectDetail.py?payment_id=${arrayList.payment_id}'">결제정보 상세 보기</button>
 </c:forEach>

 <c:if test="${empty arrayList}"> 
<tr>
 <td colspan="4"> 등록된 결제 정보가 없습니다. </td>
 </tr>
 </c:if>
 </tbody>
 </table>
